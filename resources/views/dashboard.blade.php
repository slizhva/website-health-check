...
@section('admin-body')
    ...
    <div class="row border-bottom border-top bg-light">
        <div class="col-md-3 border-start">Name</div>
        <div class="col-md-5 border-start">URL</div>
    ...
    @foreach($links as $link)
        <div class="row border-bottom align-items-center">
            <div class="p3 col-md-3 border-start p-1">{{ $link->name }}</div>
            <div class="p3 col-md-5 border-start p-1">{{ $link->url }}</div>
